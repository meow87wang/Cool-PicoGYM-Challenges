...
print(len(compress(flag + "flag{x")))
print(len(compress(flag + "flag{y")))
print(len(compress(flag + "flag{b")))

print()

print(len(compress(flag + "flag{bx")))
print(len(compress(flag + "flag{by")))
print(len(compress(flag + "flag{bc")))
